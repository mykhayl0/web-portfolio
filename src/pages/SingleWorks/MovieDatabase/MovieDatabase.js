...
export default function MovieDatabase() {
  return (
    <>
      <Helmet>
        <title>mykhaylo.ca | Kino Movies</title>
      </Helmet>
      ...
      />
      <div className={styles["movie-database__wrapper"]}>
        <section
          className={classNames(
            styles["movie-database-details"],
        ...
        >
          ...
          <p>
            ...
            application. The objective was to create a responsive, scalable, and
            a minimalistic product utilizing one of my favourite JavaScript
            libraries, React.
          </p>
        </section>
        <div className={styles["movie-database__second-section"]}>
          <section
            className={classNames(
              styles["movie-database-details"],
              styles["code"]
          ...
          >
            ...
            <p>
              As Kino Movies does not have an account system, nor a backend
              database to store user information, saving to local storage was
              the solution. By setting a key of "favourites" within the browser
              local storage, it's possible to retrieve and set items within an
              array.
            </p>
